...
<?php $__env->startSection('title', 'مراحل التصنيع وعراقة الهوية | ورشة الحدادة الفنية'); ?>
    ...
    <div class="relative border-r border-stone-800 mr-4 md:mr-12 space-y-20">
        ...
        <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative pr-8 md:pr-12">
                ...
                <span class="text-xs text-amber-500 font-semibold uppercase tracking-wider">الخطوة #<?php echo e($step->step_number); ?></span>
                <h3 class="text-xl font-bold text-stone-200 mt-1 mb-3"><?php echo e($step->title); ?></h3>
                <p class="text-stone-400 text-sm leading-relaxed mb-6"><?php echo e($step->description); ?></p>
                ...
                <?php if($step->media_path): ?>
                    <div class="max-w-2xl rounded-sm overflow-hidden border border-stone-800 bg-stone-950 p-1 mb-8">
                        <?php if($step->media_type == 'video'): ?>
                            ...
                            <video src="<?php echo e(asset('storage/' . $step->media_path)); ?>" 
                                   autoplay loop muted playsinline controls
                                   class="w-full h-auto max-h-[380px] object-cover rounded-sm">
                            </video>
                        <?php else: ?>
                            <!-- عرض صورة عالية الدقة للمرحلة -->
                            <img src="<?php echo e(asset('storage/' . $step->media_path)); ?>" 
                                 alt="<?php echo e($step->title); ?>" 
                                 class="w-full h-auto max-h-[380px] object-cover rounded-sm">
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\TURKY\Desktop\metal_said\resources\views/process.blade.php ENDPATH**/ ?>