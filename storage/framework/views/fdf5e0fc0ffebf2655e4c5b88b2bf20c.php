...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ورشة الحدادة الفنية للأبواب المدرعة'); ?></title>
    ...
    <header class="border-b border-stone-900 bg-stone-950/80 backdrop-blur sticky top-0 z-50">
        <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex gap-6 text-sm">
                ...
                <a href="<?php echo e(route('process')); ?>" class="hover:text-amber-500 transition">مراحل العمل وعراقة الهوية</a>
...
<?php /**PATH C:\Users\TURKY\Desktop\metal_said\resources\views/layout.blade.php ENDPATH**/ ?>